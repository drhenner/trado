Trado::Application.configure do
  ...
  config.assets.precompile += ['administration.js', 'administration.css','rails_admin/rails_admin.css', 'rails_admin/rails_admin.js', 'custom.css', 'css3-fallback.js', 'modernizr/modernizr.js', 'bootstrap-datepicker/js/bootstrap-datepicker.js', 'admin/soca.datepicker.js', 'bootstrap-tagsinput/dist/bootstrap-tagsinput.js', 'typeahead.js/dist/typeahead.jquery.min.js', 'admin/soca.taginput.js', 'jquery.remotipart.js', 'jquery.iframe-transport.js', 'redactor-rails/redactor.js', 'redactor-rails/config.js', 'redactor-rails/index.js']
