class Admin::Skus::VariantsController < ApplicationController
    ...
    def update
        ...
        render json: { table: render_to_string(partial: 'admin/products/skus/table'), sku_count_text: pluralize(@variant_count, "variant"), product_skus_empty: @product.active_skus.empty? }
    end
